...
\begin{equation*}
	e(w)=\frac{Dw+{Dw}^{\top}}{2},\quad \sigma(w)=2\mu\,e(w)+\lambda(\nabla\cdot w)I
\end{equation*}
\begin{equation*}
...
with 
\begin{equation*}
	S^{J}_{0} = -\alpha{Dg}^{\top}(u - v - g) + A_{\Omega}\sum_{i,j=1}^{d}{\sigma (q)}_{i,j}\nabla(e(g)_{i,j})
\end{equation*}
and
\begin{align*}
	S^{J}_{1} & = \frac{\alpha}{2}{|u-v-g|}^2 I + {}\\
			  & \quad \left(A_{\Omega}\sigma(u):e(p) + A_{\Omega}\sigma(v+g):e(q)\right)I + {} \\
